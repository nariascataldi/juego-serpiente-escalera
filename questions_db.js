// ═══════════════════════════════════════════════════════════
// BANCO DE PREGUNTAS Y CONFIGURACIÓN DEL TABLERO
// ═══════════════════════════════════════════════════════════

export const PREGUNTAS_POESIA = {
  easy: [
  ...
  medium: [
    ...
    { q: "¿Qué es la aliteración? Da un ejemplo.", hint: "Repetir sonidos parecidos: 'con el ala aleve del leve abanico'...", category: "Figuras literarias" },
...
export const PREGUNTAS_CIENCIAS_NATURALES = {
  easy: [
...
export const PREGUNTAS_CIENCIAS_SOCIALES = {
  easy: [
...
// Se puede cambiar esto para utilizar otro set de preguntas
export const QUESTIONS_DB = PREGUNTAS_CIENCIAS_NATURALES;

export const QUESTION_CELLS = {
  2: { level: "easy", fixed: 0 },
  5: { level: "easy", fixed: 1 },
  8: { level: "easy", fixed: 2 },
  12: { level: "easy", fixed: 3 },
  18: { level: "easy", fixed: 4 },
  22: { level: "easy", fixed: 9 },
  
  15: { level: "medium", fixed: 0 },
  20: { level: "medium", fixed: 1 },
  25: { level: "medium", fixed: 2 },
  30: { level: "medium", fixed: 3 },
  35: { level: "medium", fixed: 6 },
  40: { level: "medium", fixed: 4 },
  45: { level: "medium", fixed: 10 },
  55: { level: "medium", fixed: 14 },
  
  50: { level: "hard", fixed: 0 },
  60: { level: "hard", fixed: 1 },
  65: { level: "hard", fixed: 4 },
  70: { level: "hard", fixed: 6 },
  75: { level: "hard", fixed: 3 },
  80: { level: "hard", fixed: 8 },
  85: { level: "hard", fixed: 13 },
  90: { level: "hard", fixed: 12 },
  95: { level: "hard", fixed: 14 },
  98: { level: "hard", fixed: 9 },
};

export const REINFORCEMENT_CELLS = [3, 7, 10, 16, 23, 27, 33, 37, 42, 48, 52, 57, 62, 68, 72, 77, 82, 88, 92, 97];
